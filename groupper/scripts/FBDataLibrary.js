		...
		function fqlQuery_json(lastUpdateTime){
			...
			FB.api('/me', function(response) {
				...
				FB.api( {
                    method: 'fql.query',
                    query:'select thread_id, message_id, created_time, viewer_id, author_id from message where created_time>' + lastUpdateTime +' and thread_id in (select thread_id from thread where viewer_id=me() and folder_id=0 LIMIT 3000) LIMIT 5000'
                    //query:'select thread_id, message_id, created_time, viewer_id, author_id from message where thread_id in (select thread_id from thread where viewer_id=me() and folder_id=0) LIMIT 100000'            
                },
                function(rows) {
