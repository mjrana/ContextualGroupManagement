document.write("<script src=\"http://a4647.research.ltu.se/~satin/sandbox/friendinfo/script/jquery.js\" type=\"text/javascript\" > </script>"); 
document.write("<script src=\"http://a4647.research.ltu.se/~satin/sandbox/friendinfo/script/json2.js\" type=\"text/javascript\" > </script>"); var labelType, useGradients, nativeTextSupport, animate;
var retVal=[];
(function() {
...
function SATIN_readJson(){
		...
		var data="file="+"test.json";
		var txtFile =CreateXMLHttpRequest();
		
		
		txtFile.open("POST", "http://www.s11group.com/cgi-bin/ACD/ACD.js?uri=(http://a4647.research.ltu.se/~satin/sandbox/userinterface/RGJson.php)", false);
		txtFile.onreadystatechange = function() {
			if (txtFile.readyState == 4) { 
					if (txtFile.status == 200) { 						
							//retVal= JSON.stringify(jQuery.parseJSON(txtFile.responseText));
							//retVal= JSON.stringify(txtFile.responseText);
							retVal= eval('('+txtFile.responseText+')');
							//
...
function init(){
 ...
 var json1 = {
	...
	//rgraph.loadJSON(SATIN_readJson());
